...
class ZkGeneator:
    ...
    """
    def __init__(self, real_patients: List[PatientRecord], seed: Optional[int] = None):
        """
        Initialize the ZK Generator.

        Args:
            real_patients: List of real patient records to learn from.
