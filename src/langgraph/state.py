...
class ResearchState(TypedDict):
    ...
    # SOP pipeline (Phase 4)
    sop_pipeline: Optional[List[str]]
    sop_current_step: int
    sop_accumulated_context: Optional[str]
