...
def route_request(message: str) -> Tuple[str, str, List[str]]:
    ...
    priority_keywords = {
        ...
        "revising my paper": ("Writing & Synthesis", "SOP_MANUSCRIPT_REVISION"),
        "revise my paper": ("Writing & Synthesis", "SOP_MANUSCRIPT_REVISION"),
        ...
        "project management files": ("Strategy & Operations", "SOP_PROJECT_KICKOFF"),
