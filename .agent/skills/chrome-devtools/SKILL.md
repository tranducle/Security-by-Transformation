...
SKILL_DIR=""
if [ -d ".agent/skills/chrome-devtools/scripts" ]; then
  SKILL_DIR=".agent/skills/chrome-devtools/scripts"
elif [ -d "$HOME/.agent/skills/chrome-devtools/scripts" ]; then
  SKILL_DIR="$HOME/.agent/skills/chrome-devtools/scripts"
fi
...
Skills can exist in **project-scope** or **user-scope**. Priority: project-scope > user-scope.
All in `.agent/skills/chrome-devtools/scripts/`:
...
node "$SKILL_DIR/screenshot.js" --output ./.agent/skills/chrome-devtools/screenshots/debug.png
